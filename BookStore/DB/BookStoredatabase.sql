USE [master]
GO
/****** Object:  Database [BookStore] ******/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'IIBOOK')
BEGIN
	ALTER DATABASE [BOOKSTORE] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [BOOKSTORE] SET ONLINE;
...
USE [BOOKSTORE]
GO
/****** Object:  Table [dbo].[book]    BOOKSTORE ******/
SET ANSI_NULLS ON
GO
